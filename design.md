...
1. Compact hero deposit card
2. Footer reservation brief with demand-proof copy
...
- Use the heading `Request a refundable $25 deposit`.
...
- Keep the section title `Priority deposit request`.
- Keep the longer reservation brief in the footer.
...
- Use the heading `Share to keep the priority list moving`.
...
- Use the phrase `reservation brief` only for the footer treatment, not the hero card.
